<?php
/**
 * Lucide icon SVG path registry for server-side rendering.
 *
 * Mirrors the curated icon set in assets/js/lucide-icons.js.
 * All icons from Lucide (https://lucide.dev) — ISC License.
 *
 * @package AGoodSign
 */
...
class AGoodSign_Icons {

	/**
	 * Get SVG inner content for an icon.
	 *
	 * @param string $name Icon name.
	 * @return string SVG inner content, or empty string if not found.
	 */
	 ...
	 */
	public static function render( $name, $size = 24, $color = '#ef4444' ) {
		$path = self::get_path( $name );
		if ( ! $path ) {
			$path = self::get_path( 'map-pin' );
		}

		return sprintf(
			'<svg xmlns="http://www.w3.org/2000/svg" width="%1$d" height="%1$d" viewBox="0 0 24 24" fill="none" stroke="%2$s" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">%3$s</svg>',
			absint( $size ),
			esc_attr( $color ),
			$path
		);
	...
	/**
	 * Get all icon paths keyed by name.
	 *
	 * @return array Icon name => SVG inner content.
	 */
	private static function get_icons() {
		...
		$icons = array(
			...
			'shower-head'      => '<path d="m4 4 2.5 2.5"/><path d="M13.5 6.5a4.95 4.95 0 0 0-7 7"/><path d="M15 5 5 15"/><path d="M14 17v.01"/><path d="M10 16v.01"/><path d="M13 13v.01"/><path d="M16 10v.01"/><path d="M11 20v.01"/><path d="M17 14v.01"/><path d="M20 11v.01"/><path d="M14 14v.01"/>',
			...
			'toilet'           => '<path d="M7 12h13a1 1 0 0 1 .928 1.372L18 22H6l-1-5"/><path d="M3.42 11.145A1.993 1.993 0 0 1 2 9.19V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v5.19a1.993 1.993 0 0 1-1.42 1.955L7 12"/>',
			'cigarette-off'    => '<line x1="2" x2="22" y1="2" y2="22"/><path d="M12 12H2v4h14"/><path d="M22 12v4"/><path d="M18 12h-.5"/><path d="M7 12v4"/><path d="M18 8c0-2.5-2-2.5-2-5"/><path d="M22 8c0-2.5-2-2.5-2-5"/>',
			...
			'tree-pine'        => '<path d="m17 14 3 3.3a1 1 0 0 1-.7 1.7H4.7a1 1 0 0 1-.7-1.7L7 14l-3-3.3a1 1 0 0 1 .7-1.7h3.6L7 7.3a1 1 0 0 1 .7-1.7h8.6a1 1 0 0 1 .7 1.7L16 9h3.3a1 1 0 0 1 .7 1.7z"/><path d="M12 22v-3"/>',
